...
<div class="place fl wfs">
                <p class="fl">当前位置：<a href="/">首页</a>&nbsp;>&nbsp;<span>动态中心</span></p>
            
            
                        <div class="about-news fl w900">
                <ul class="items fl wfs">
                                      <li class="news-list fl wfs">
                        <span  class="circle-yellow" >2014/12</span>
                        <div>
                            <h5><a href="#">标题 标题 标题 标题 标题 标题 </a></h5>
